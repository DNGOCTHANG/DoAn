                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('user.authUser')); ?>">
                            ...
                            <div class="form-group mb-3 text-right">
                                <a href="<?php echo e(route('crud_user.forgot_password')); ?>">Quên mật khẩu?</a>
                            </div>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\DoAn\example-app\resources\views/crud_user/login.blade.php ENDPATH**/ ?>